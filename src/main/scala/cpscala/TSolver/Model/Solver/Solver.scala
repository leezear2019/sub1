...
abstract class Solver[VT <: Var :ClassTag, PT <: Propagator with IPPropagator with DSPPropagator :ClassTag](xm: XModel, propagatorName: String, varType: String, heuName: String) {
